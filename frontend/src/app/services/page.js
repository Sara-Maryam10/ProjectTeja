...
export default function ServicesPage() {
  return (
    <main className="bg-[#f5f5f5] text-black overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-28 grid md:grid-cols-3 gap-10">
        {[
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-black text-white p-10 rounded-3xl shadow-2xl hover:-translate-y-3 hover:shadow-black/40 transition-all duration-300"
          >
      ...
      {/* CTA */}
      <section className="text-center py-28 px-6 bg-[#f5f5f5]">
        <motion.h2
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-black text-white px-10 py-4 rounded-full font-semibold shadow-lg hover:bg-gray-800 transition"
        >
          Contact Us
        </motion.a>
      </section>
