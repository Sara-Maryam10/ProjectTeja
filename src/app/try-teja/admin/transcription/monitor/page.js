...
export default function TranscriptionMonitor() {
  ...
  const task = {
    ...
    assignee: "John Doe",
    url: "https://example.com/audio/podcast42.mp3",
  };

  const transcript = `00:00 - Introduction
00:45 - Welcome to today's episode where we discuss...
01:30 - Our main topic for today is about...
05:00 - Let's dive into the first point...
10:30 - Now let's talk about the second aspect...
20:00 - Interview segment begins...
35:00 - Conclusion and wrap up...
44:30 - Thank you for listening!`;
  ...
  const activityLog = [
    ...
    { id: 3, action: "Audio file downloaded", user: "John Doe", date: "2024-01-15 11:00 AM" },
    { id: 4, action: "Transcription in progress", user: "John Doe", date: "2024-01-15 11:30 AM" },
    { id: 5, action: "First 15 minutes transcribed", user: "John Doe", date: "2024-01-15 02:00 PM" },
  ];
    ...
    <div className="min-h-screen bg-white text-black p-6 md:p-10">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-semibold">Monitor Transcription Task</h1>
        </div>
        <p className="text-black/60 mt-1 ml-14">Track progress and manage the transcription task</p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-white/60 text-sm mt-1">{task.sourceType} • {task.format} • {task.duration} • {task.language}</p>
              </div>
            ...
            <div className="mb-6">
              <h3 className="text-sm font-medium text-white/60 mb-2">Media File</h3>
              <div className="bg-white/5 rounded-lg p-4">
                <p className="text-white/80 text-sm">{task.url}</p>
            ...
            {/* Transcript */}
            <div>
              <h3 className="text-sm font-medium text-white/60 mb-2">Transcript</h3>
              <div className="bg-white/5 rounded-lg p-4 text-white/80 whitespace-pre-line text-sm">
                {transcript}
              </div>
            </div>
          </motion.div>
