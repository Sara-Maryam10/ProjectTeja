    ...
    <div className="flex items-center justify-center min-h-screen bg-white text-white px-4">
      ...
      >
        <form
          ...
          className="bg-black backdrop-blur-xl border border-white/10 p-10 rounded-2xl shadow-2xl"
        >
          {/* Title */}
          ...
          <input
            ...
            placeholder="Email"
            required
            className="w-full mb-4 p-3 bg-white/40 border border-white/20 rounded-lg focus:outline-none focus:border-white transition-all duration-300"
          />
