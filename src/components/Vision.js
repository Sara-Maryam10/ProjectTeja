...
export default function Vision() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full h-[110vh] overflow-hidden bg-black"
    >
      ...
      <motion.div
        className="absolute bottom-0 left-0 w-full h-px bg-linear-to-r from-transparent via-white/40 to-transparent"
